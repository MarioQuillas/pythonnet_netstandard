    ...
    class Program
    {
        ...
        static void Main(string[] args)
        {
            var specs = new ReleaseSpec[]
            {
                ...
                new ReleaseSpec() { Version = V, Description = Description + net + "3.8 (linux)", PackageId = Package+"_py38_linux", PackageTags = Tags, Constants = "PYTHON3;PYTHON38;UCS4;MONO_LINUX"+MALLOC+COMMON, RelativeProjectPath = ProjectPath, ProjectName = ProjectName, Framework="net40" },
                // mac
                ...
                new ReleaseSpec() { Version = V, Description = Description + net + "3.8 (osx)", PackageId = Package+"_py38_osx", PackageTags = Tags, Constants = "PYTHON3;PYTHON38;UCS2;MONO_OSX"+MALLOC+COMMON, RelativeProjectPath = ProjectPath, ProjectName = ProjectName, Framework="net40" },
                // win
                ...
                new ReleaseSpec() { Version = V, Description = Description + netstd + "3.8 (linux)", PackageId = PackageNetstd+"_py38_linux", PackageTags = Tags, Constants = "PYTHON3;PYTHON38;UCS4;MONO_LINUX"+MALLOC+NETSTD+COMMON, RelativeProjectPath = ProjectPath, ProjectName = ProjectNameNetStandard, Framework="netstandard2.0" },
                // mac
                ...
                new ReleaseSpec() { Version = V, Description = Description + netstd + "3.8 (osx)", PackageId = PackageNetstd+"_py38_osx", PackageTags = Tags, Constants = "PYTHON3;PYTHON38;UCS2;MONO_OSX"+MALLOC+NETSTD+COMMON, RelativeProjectPath = ProjectPath, ProjectName = ProjectNameNetStandard, Framework="netstandard2.0" },
                // win
